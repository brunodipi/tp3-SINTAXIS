...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_sentencia_asignacion = 20,      /* sentencia_asignacion  */
  YYSYMBOL_21_1 = 21,                      /* $@1  */
  YYSYMBOL_sentencia_entrada = 22,         /* sentencia_entrada  */
  YYSYMBOL_lista_id = 23,                  /* lista_id  */
  YYSYMBOL_lista_expresiones = 24,         /* lista_expresiones  */
  YYSYMBOL_expresion = 25,                 /* expresion  */
  YYSYMBOL_primaria = 26,                  /* primaria  */
  YYSYMBOL_operadorAditivo = 27            /* operadorAditivo  */
};
...
static const char *const yytname[] =
{
  ...
  "SUMA", "RESTA", "PARENIZQUIERDO", "PARENDERECHO", "COMA", "ID",
  "CONSTANTE", "INICIO", "FIN", "LEER", "ESCRIBIR", "$accept", "programa",
  "sentencias", "sentencia", "sentencia_asignacion", "$@1",
  "sentencia_entrada", "lista_id", "lista_expresiones", "expresion",
  "primaria", "operadorAditivo", YY_NULLPTR
};
...
{
     -10,    -3,    15,   -17,    22,    23,    -9,   -17,   -17,   -17,
     -17,    17,    18,     6,   -17,   -17,     6,   -17,    14,     6,
     -17,   -17,    16,    21,   -17,     4,    27,    24,    13,    28,
       6,   -17,   -17,     6,   -17,   -17,   -17,   -17,   -17,    21,
     -17
};
...
{
       0,     0,     0,     7,     0,     0,     0,     4,     5,     6,
       1,     0,     0,     0,     2,     3,     0,    11,     0,     0,
      17,    18,     0,    13,    15,     0,     0,     0,     0,     0,
       0,    20,    21,     0,     8,     9,    12,    19,    10,    14,
      16
};
...
{
      25,     3,     1,    28,    14,     4,     5,     3,    34,    31,
      32,     4,     5,    19,    39,    10,    20,    21,    31,    32,
      16,    37,    26,    27,    29,    30,    31,    32,    17,    12,
      13,    35,    38,    40,    36,    15
};

static const yytype_int8 yycheck[] =
{
      16,    10,    12,    19,    13,    14,    15,    10,     4,     5,
       6,    14,    15,     7,    30,     0,    10,    11,     5,     6,
       3,     8,     8,     9,     8,     9,     5,     6,    10,     7,
       7,     4,     4,    33,    10,     6
};
...
{
       0,    12,    17,    10,    14,    15,    18,    19,    20,    22,
       0,    21,     7,     7,    13,    19,     3,    10,    23,     7,
      10,    11,    24,    25,    26,    25,     8,     9,    25,     8,
       9,     5,     6,    27,     4,     4,    10,     8,     4,    25,
      26
};
...
#line 120 "bison.y"
	...
	if(!buscarSimbolo((yyvsp[0].cadena))) {
		char buffer[256];
		sprintf(buffer, "Error semantico: Uso de ID ('%s') no declarado", (yyvsp[0].cadena));
		yyerror(buffer);
